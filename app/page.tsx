          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-12 lg:gap-20">
            <div className="flex-1 space-y-8">
              ...
              <div className="flex flex-wrap gap-4 pt-4 sm:justify-center md:justify-start lg:justify-start">
                <button className="h-14 px-8 rounded-xl purple-gradient-bg text-white font-bold text-lg hover:scale-[1.02] transition-transform flex items-center gap-2">
                  View Work{" "}
                  <span className="material-symbols-outlined">
                    arrow_forward
                  </span>
                </button>
                <button className="h-14 px-8 border border-accent-purple text-accent-purple rounded-xl font-bold hover:scale-[1.02] transition-transform">
                  Get in Touch
                </button>
              </div>
            </div>
              ...
              <div className="relative group">
                ...
                <div className="relative aspect-square rounded-2xl overflow-hidden bg-surface-dark border border-primary/10">
                  {/* <Image
                    ...
                    data-alt="Laptop screen showing code with purple neon lighting"
                    src="https://images.remote.com/image_0.png"
                  /> */}
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-12 gap-12 items-center">
            ...
            <div className="md:col-span-7 grid grid-cols-2 gap-4">
              <div className="p-8 glass-card text-center">
                <div className="text-4xl font-black purple-gradient-text mb-2">
                  5+
                </div>
                <div
        ...
        <section className="py-24">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="group cursor-pointer">
              <div className="aspect-video rounded-2xl overflow-hidden mb-6 bg-surface-dark relative">
                <img
                  ...
                  data-alt="Modern sleek SaaS dashboard UI interface"
              ...
              <p
                ...
                style={{ color: "#666666" }}
              >
                A high-performance analytics engine for e-commerce brands with
            ...
            <div className="group cursor-pointer">
              <div className="aspect-video rounded-2xl overflow-hidden mb-6 bg-surface-dark relative">
                <img
                  alt="Mobile banking application screens"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                  data-alt="Minimalist mobile app screens for banking"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuBu7GDyJi0grL2uCocb2Cq8Ek9GbqnKMzP7XMyETRiIbkU8DsCB6h7PWp6xBr44oENLpD7Ne9T3UoxfL-cUt-JXh571hX_MPD6H6Wb1FM4HpCKyUzg0W9Ia423oem7RtFKavAOT7SMR3MKH7Y6HMhCr8qej1_RaZbt1npqtU3M1ZjL4ujUfUS_JNPnf0_HlDtN_WcmLBuA-oQt3aKu3ZceaU4_IYTva30xUCa0bcHSs5Xi5nau05Jzfp2t7j9WivfROmUZI3ByPIc-H"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-8">
                  <span className="text-white font-bold flex items-center gap-2">
                    View Case Study{" "}
              ...
              <p
                ...
                style={{ color: "#666666" }}
              >
                Redefining personal finance with a focus on accessibility and
                security through biometric integration.
              </p>
              <div className="flex gap-2">
                <span className="px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-semibold">
                  React Native
