...
export default function ProjectsPage() {
  // Array dei progetti per mantenere il codice pulito
  const projects = [
    {
  ...
  return (
    <main className="max-w-[1600px] mx-auto w-full px-6 py-8 md:py-12">
      {/* Intestazione Pagina */}
      ...
      <div className="flex flex-wrap items-center justify-between gap-6 border-b border-slate-200 dark:border-slate-800 mb-8">
        <div className="flex gap-8 overflow-x-auto pb-1">
          <Link
            href="#"
            className="flex flex-col items-center justify-center border-b-2 border-primary text-primary pb-3 font-bold text-sm tracking-wide whitespace-nowrap"
          >
            All Work
          </Link>
          <Link
            href="#"
            className="flex flex-col items-center justify-center border-b-2 border-transparent text-slate-500 hover:text-slate-900 dark:hover:text-slate-100 pb-3 font-medium text-sm transition-all whitespace-nowrap"
          >
            Web Design
          </Link>
          <Link
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-start">
                ...
                <span className="material-symbols-outlined text-primary text-xl transition-transform group-hover:-translate-y-1 group-hover:translate-x-1">
                  arrow_outward
                </span>
              </div>
